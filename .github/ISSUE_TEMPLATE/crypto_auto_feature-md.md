---
name: crypto_auto_feature.md
about: crypto_auto_feature.md
...
def modular_crypto_auto(a=14641, b=5, auto=True, admin_email=None, threshold_check=lambda: True):
    ...
    if not threshold_check():
        ...
        print(f"Threshold exceeded or policy prevents auto-run. Only admin ({ADMIN_EMAIL}) may input values manually.")
    ...
    if auto:
        ...
        a_prime = sympy.nextprime(a)
        b_prime = sympy.nextprime(b)
